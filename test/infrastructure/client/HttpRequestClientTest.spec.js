...
describe('HttpRequestClient client return httpresponse ok', function () {
    ...
    it('test method sendFormUrlEncodedContentAsync returns response ok', async function () {
    ...
    it('test method sendFormUrlEncodedContentAsync returns response notfound', async function () {
    
        let client = new HttpRequestClient();
        let form = { name : "test", email : "test@te" }
        let result = await client.sendFormUrlEncodedContentAsync("https://httpbin.org/pest", form);
